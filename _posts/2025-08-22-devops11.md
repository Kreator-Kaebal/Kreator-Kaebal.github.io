...
AWS CLI는 그냥 [https://docs.aws.amazon.com/ko_kr/cli/latest/userguide/getting-started-install.html](여기) 들어가서 받고 설치해주면 끝난다.
...
이제 aws 딸각충이 되었으니 다음 목표인 그라파나를 하러 가보자